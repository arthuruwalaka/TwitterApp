...
// login screen, login button takes you to authentication
class LoginComponent extends Component {
	...
	// check if user is already logged in, if so send to home page
	...
	render() {
		...
		return (
			<div className="login-div">
				...
				<p style={{ fontSize: "2em", marginBottom: "1.5em" }}>Search Bookmarks</p>
				<svg
				...
				>
					<rect width="216" height="47" x=".5" y=".5" fill={"#1D9BF0"} stroke="#1D9BF0" rx="23.5" />
					<path
						fill={"#FFFFFF"}
